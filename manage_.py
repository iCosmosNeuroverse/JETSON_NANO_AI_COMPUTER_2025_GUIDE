...
#ip_cam_url eg = "http://192.168.100.192:8080/video". (Invoke:>>> python manage.py drive --ip_cam_url="http://192.168.100.192:8080/video")

def drive(cfg, model_path=None, use_joystick=False, model_type=None,
          camera_type='single', meta=[], ip_cam_url=None):
    """
    ...
    #
    add_camera(V, cfg, camera_type,ip_cam_url)
    if cfg.ENABLE_OBJECT_DETECTION:
        ...
        V.add(yolo, inputs=['cam/image_array'], outputs=['cam/image_array', 'detect/objects'], threaded=False)
...
def add_camera(V, cfg, camera_type,ip_cam_url):
    """
    ...
    logger.info(">>>>>>>>>>>>ip_cam_url %s"%ip_cam_url)
